        ...
        <div id="center" class="col-xs-12 col-sm-8 col-sm-pull-2">
			<div class="row well">		
						...
						<div class="col-xs-12 col-sm-3">
								<button class="btn btn-secondary" type="button"><a data-toggle="collapse" href="#collapse1">Add post</a></button>
						</div>
						<div class="col-xs-12 col-sm-4">
								<button class="btn btn-secondary" type="button"><a>Leave group</a></button>
						</div>
			</div>
			<div class="row">
