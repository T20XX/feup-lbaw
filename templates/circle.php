...
<<<<<<< HEAD
			<div class="row well">	
						<div class="col-xs-12">
							<h2 style="text-align:center; margin-top:0%">Circle Name</h2>
						</div>
						<div class="col-xs-12 col-sm-5 ">
							<input type="text" class="form-control" placeholder="Search inside this circle...">
						</div>
						<div class="col-xs-6 col-sm-3">
							<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="collapse" href="#collapse1">Post
						</div>
						<div class="dropdown col-xs-6 col-sm-4">
                ...
                <div class="col-xs-6 col-sm-3 col-sm-offset-1">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#">
                                    <div class="input-group">
>>>>>>> 8a1a26131e17509f8f71921748986f885a93c100
